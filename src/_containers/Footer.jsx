        ...
        <footer className="footer">
            <div className="footer__top top-footer">
                <div className="top-footer__container">
                    ...
                    <nav className="top-footer__column">
                    ...
                    <nav className="top-footer__column">
                        ...
                        <ul className="top-footer__list">
                            ...
                            <li className="top-footer__item">
                                <Link to="/contact" className="top-footer__link">
                                    Contact
                                </Link>
                            </li>
                        </ul>
                    ...
                    <nav className="top-footer__column">
                        <h5 className="top-footer__label">Follow us</h5>
                        <ul className="top-footer__list top-footer__list_socials">
                            <li className="top-footer__item">
                                <a href="#" className="top-footer__social-link">
                                    <svg width="9" height="18" viewBox="0 0 9 18" fill="white" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.95282 2.89077H8.50569V0.186185C8.23779 0.14933 7.31641 0.0664062 6.24337 0.0664062C4.00443 0.0664062 2.4707 1.47469 2.4707 4.06304V6.44514H0V9.46867H2.4707V17.0764H5.49989V9.46937H7.87065L8.247 6.44585H5.49918V4.36284C5.49989 3.48895 5.73519 2.89077 6.95282 2.89077Z" />
                                    </svg>
                                </a>
                            </li>
                            <li className="top-footer__item">
                            ...
                            <li className="top-footer__item">
                                <a href="#" className="top-footer__social-link">
                                    <svg
                                        ...
                                        <defs>
                                            <clipPath id="clip0_9701_204">
                                                <rect width="16" height="16" transform="translate(0.410156 0.571533)" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </a>
            ...
            <div className="footer__bottom bottom-footer">
                <div className="bottom-footer__container">
                    <div className="bottom-footer__copy">© {format(new Date(), "yyyy")} Mozi - All right reserved</div>
                    <a href="#" className="bottom-footer__terms">
                        Terms & Conditions
                    </a>
                </div>
            </div>
